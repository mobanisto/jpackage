...
package mobanisto.jpackage.main;

import mobanisto.jpackage.internal.Arguments;
import mobanisto.jpackage.internal.Log;
import mobanisto.jpackage.internal.CLIHelp;
...
public class Main {
    ...
    public static final ResourceBundle I18N = ResourceBundle.getBundle(
            "mobanisto.jpackage.internal.resources.MainResources");
    ...
    public static void main(String... args) throws Exception {
        ...
        int status = new mobanisto.jpackage.main.Main().execute(out, err, args);
        System.exit(status);
    }
